 ...
 */
class CreatePrenatalFlowsheet extends Request implements HasBody
{
    use HasFormBody;
    ...
    {
        return "/chart/{$this->patientid}/obepisodes/{$this->obepisodeid}/flowsheets";
    }

    /**
     * @param  int  $departmentid  ID of the department the patient was seen in.
     * @param  string  $encounterdate  Date in which the patient was seen.
     ...
     * @param  null|string  $provider  Name of the rendering provider. If not supplied, this will default to the username of the providerid supplied.
     * @param  null|int  $providerid  ID of the rendering provider
