 ...
 * UpdateProvider
 *
 * BETA: Modifies information of the specific provider
 */
class UpdateProvider extends Request implements HasBody
{
    use HasFormBody;
     ...
     * @param  int  $entitytypeid  The entity type of provider. 1 = person, 2 = non-person entity
     ...
     * @param  null|int  $medicalgroupid  The medical group of the provider.
    ...
    public function __construct(
        ...
        protected ?int $medicalgroupid = null,
