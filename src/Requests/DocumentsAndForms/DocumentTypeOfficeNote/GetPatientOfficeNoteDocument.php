...
namespace ChrisReedIO\AthenaSDK\Requests\DocumentsAndForms\DocumentTypeOfficeNote;
 ...
 */
class GetPatientOfficeNoteDocument extends Request
{
	...
	{
		return "/patients/{$this->patientid}/documents/officenote";
	}
