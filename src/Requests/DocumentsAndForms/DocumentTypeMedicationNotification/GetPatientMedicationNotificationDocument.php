...
namespace ChrisReedIO\AthenaSDK\Requests\DocumentsAndForms\DocumentTypeMedicationNotification;
 ...
 *
 * Retrieves medication notification of a specific patient
 */
class GetPatientMedicationNotificationDocument extends Request
{
    protected Method $method = Method::GET;

    public function resolveEndpoint(): string
    {
        return "/patients/{$this->patientid}/documents/mednotification";
    }
