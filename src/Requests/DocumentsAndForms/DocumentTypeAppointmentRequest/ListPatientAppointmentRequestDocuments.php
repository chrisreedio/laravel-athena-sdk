...
namespace ChrisReedIO\AthenaSDK\Requests\DocumentsAndForms\DocumentTypeAppointmentRequest;
 ...
 *
 * Retrieves a list of patients appointment request document
 */
class ListPatientAppointmentRequestDocuments extends Request
{
    protected Method $method = Method::GET;

    public function resolveEndpoint(): string
    {
        return "/patients/{$this->patientid}/documents/appointmentrequest";
    }
