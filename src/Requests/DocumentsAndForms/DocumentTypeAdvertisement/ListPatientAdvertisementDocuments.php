...
namespace ChrisReedIO\AthenaSDK\Requests\DocumentsAndForms\DocumentTypeAdvertisement;
 ...
 *
 * Retrieves a list of advertisement documents for patient
 */
class ListPatientAdvertisementDocuments extends Request
{
    protected Method $method = Method::GET;

    public function resolveEndpoint(): string
    {
        return "/patients/{$this->patientid}/documents/advertisement";
    }
