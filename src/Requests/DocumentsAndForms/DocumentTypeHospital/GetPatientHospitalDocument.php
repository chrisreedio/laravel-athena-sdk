...
namespace ChrisReedIO\AthenaSDK\Requests\DocumentsAndForms\DocumentTypeHospital;
 ...
 *
 * Retrieves a list of hospital documents information of a specific patient
 */
class GetPatientHospitalDocument extends Request
{
    protected Method $method = Method::GET;

    public function resolveEndpoint(): string
    {
        return "/patients/{$this->patientid}/documents/hospital";
    }
