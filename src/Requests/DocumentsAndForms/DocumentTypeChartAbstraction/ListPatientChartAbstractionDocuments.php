...
namespace ChrisReedIO\AthenaSDK\Requests\DocumentsAndForms\DocumentTypeChartAbstraction;
 ...
 *
 * Retrieves a list of patient's chart abstraction
 */
class ListPatientChartAbstractionDocuments extends Request
{
	...
	{
		return "/patients/{$this->patientid}/documents/chartabstraction";
	}
