...
namespace ChrisReedIO\AthenaSDK\Requests\DocumentsAndForms\DocumentTypePatientRecord;
 ...
 * ListPatientRecords
 *
 * Retrieves the list of a patient record for a specific person
 */
class ListPatientRecords extends Request
{
    protected Method $method = Method::GET;

    public function resolveEndpoint(): string
    {
        return "/patients/{$this->patientid}/documents/patientrecord";
    }
