...
namespace ChrisReedIO\AthenaSDK\Requests\DocumentsAndForms\DocumentTypeReturnOfficeRto;
 ...
 *
 * Retrieves a list of  RTO documents
 */
class ListPatientReturnToOfficeDocuments extends Request
{
    protected Method $method = Method::GET;

    public function resolveEndpoint(): string
    {
        return "/patients/{$this->patientid}/documents/rto";
    }
