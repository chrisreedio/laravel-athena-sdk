...
class ListPatientsByEnhancedBestMatch extends Request
{
    ...
    public function __construct(
        protected ?bool $showprivacycustomfields,
        protected string $firstname,
        protected ?bool $limitlocalpatientid,
        protected ?bool $showinsurance,
        protected ?string $preferredname,
        protected ?bool $showportalstatus,
        protected ?string $email,
        protected float|int|null $minscore = null,
        protected ?string $suffix,
        protected ?int $departmentid,
        protected ?bool $returnbestmatches,
        protected ?string $homephone,
        protected ?array $confidentialitycode,
        protected ?bool $showallpatientdepartmentstatus,
        protected ?bool $showpreviouspatientids,
        protected ?bool $showallclaims,
        protected string $dob,
        protected ?string $zip,
        protected ?bool $usesoundexsearch,
        protected ?string $workphone,
        protected ?bool $showfullssn,
        protected ?bool $showlocalpatientid,
